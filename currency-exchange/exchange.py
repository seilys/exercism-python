...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    return get_value_of_bills(bills_exchanged, denomination)
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchanged_value = exchange_money(budget, exchange_rate * (1 + spread/100))
    return int(exchanged_value - exchangeable)
